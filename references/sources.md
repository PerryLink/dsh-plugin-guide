...
- GitHub topic：https://github.com/topics/dsh-plugin（304 仓库全量清单在工作区 `dsh-plugin-topic-2026-08-13/`，抓取时间 2026-08-13T15:15Z）
...
- dsh-external/hub（生态 hub）：https://github.com/dsh-external/hub
...
- turtle-ui（git 安装 prepare 范例）：https://github.com/deepseek-harness/turtle-ui
...
- 重跑：两个脚本均幂等，可随时刷新。
- 时间戳：下载会话当日（详见 manifest 与文件 mtime）；dsh-plugin topic 快照时间固定为 2026-08-13T15:15:06Z。
