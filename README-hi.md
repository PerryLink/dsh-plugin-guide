...
| Surface | Status |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-alpha.1` (2026-09-18 को पुनः-सिंक किया गया, `ddefc45`): आधिकारिक दस्तावेज़ स्नैपशॉट alpha.2 पर ताज़ा किया गया; checker अब तीन-खंड peer रेंज (`… || >=0.1.6-0 <0.2.0`) की अपेक्षा करता है (स्कैफ़ोल्ड टेम्पलेट्स के साथ एकल स्रोत); नई रेड लाइन — पहले `await` के बाद पंजीकरण करने वाले `async apply` विफल होते हैं। स्थानीय gate chain हरा (40 टेस्ट, typecheck, verify dogfood); compat job की वास्तविक alpha.2 रन अगले CI push के साथ आती है। |
