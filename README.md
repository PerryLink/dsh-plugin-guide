...
|---|---|---|---|---|---|
| 215 pages (EN + ZH) | 111 repos | 20+ | ~1000 snapshot (API ≈2670) | EN · 中文 · ES · PT · HI | `dsh-plugin-guide` |
...
| `references/*.md` | Research reports: repo docs, website, Cordis, the paper, community ecosystem, 111-repo archive (15 deep-dived) |
