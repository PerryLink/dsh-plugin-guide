    ...
    switch (command) {
      ...
      case 'verify': {
        ...
        const result = await runVerify({
          ...
          base: flagString(flags, 'base', '@deepseek-ai/dsh-base@0.1.7-rc.1') ?? '@deepseek-ai/dsh-base@0.1.7-rc.1',
          headless: flagString(flags, 'headless', '@deepseek-ai/dsh-headless@0.1.7-rc.1') ?? '@deepseek-ai/dsh-headless@0.1.7-rc.1',
